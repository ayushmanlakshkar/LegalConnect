...
import Question from './QuestionsSection/Question';
...
function QuestionsSection() {
    ...
    return (
        <div className='w-full lg:w-7/12 h-full overflow-y-auto text-text sm:px-8 scrollbar-none'>
            <div className='lg:hidden sm:w-full  flex flex-col gap-3 lg:flex-col mx-5 sm:mx-0 sm:flex-row bg-secondary py-5 px-5 mt-5 rounded-lg border-[1px] border-text border-opacity-10'>
            ...
            <div className='min-w-auto w-full bg-secondary border-opacity-10 px-4 flex  flex-col divide-y divide-opacity-50 divide-text my-5 border-[1px] border-text rounded-lg'>
                {sampleQuestions.map((question) => {
                    return (
                        <Question question={question} color={getColorById(question.id)}/>
                    )
                })}
            </div>
        </div>
